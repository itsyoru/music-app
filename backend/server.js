...
mongoose
  .connect(
    "mongodb+srv://fkhan27:r2BPsC9bt8K49GE8@sysdesign.alwougr.mongodb.net/den?retryWrites=true&w=majority&appName=sysdesign",
...
app.post("/reviews", async (req, res) => {
  ...
  const { user, spotifyID, rating, comment, albumName, albumCoverArt } =
    req.body;
...
app.get("/new-releases", async (req, res) => {
  ...
  axios({
    ...
    .then((response) => {
      ...
      const firstSixReleases = newReleasesData.slice(0, 6);
...
const albumIds = [
  ...
  "0tpIUAzCeUkoV4u2r5NrQr",
  "6tG8sCK4htJOLjlWwb7gZB",
  "3mH6qwIy9crq0I9YQbOuDf",
  "1VCTWaze9kuY5IDlbtR5p0",
  "7wJTn94PWzZ3zE0lg3qhld",
];
...
app.get("/albums/:id/tracks", async (req, res) => {
  ...
  axios({
    ...
    .catch((error) => {
      ...
      res
        .status(500)
        .json({ error: "An error occurred while fetching track data." });
    });
});
...
const rapalbums = [
  ...
  "4Q7cRXio6mF2ImVUCcezPO",
  "7dAm8ShwJLFm9SaJ6Yc58O",
  "7IyoGB8J31fvQDwGtHAq9m",
  "2yXnY2NiaZk9QiJJittS81",
  "3bSNhnaQQXpC639OQ4pMyP",
...
const popalbums = [
  "1hmlhl74JfLyUqmqtCwvFb",
  "3q149oaxOiW9EoHXqM5nvO",
  "2IUoE0jqkViW6gGfqLcjG2",
  "3KGVOGmIbinlrR97aFufGE",
